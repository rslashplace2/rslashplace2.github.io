(async function(){
    if (new Date().getMonth() === 11) {
        const CanvasSnow = await import('./canvas-snow.esm.min.js')
        console.log(
            "%cHappy Holidays!",
        ...
        hat.src = "svg/santa-hat.svg"
        hat.setAttribute("style", "position: absolute;  height: 128px; z-index: 22;left: calc(50% - 160px);top: calc(50% - 110px);transform: rotate(-30deg);")
        document.getElementById("loadingScreen").appendChild(hat)
